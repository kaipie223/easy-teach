    ...
    unit_specs = [
        ...
        },
        {
            ...
            "blocks": [
                ...
                ("text", "灯泡灯丝断了，或灯泡内部连接处断开，也属于灯泡断路。", "corrected", "对应视频 03:23–04:05 的灯泡内部断开示例。"),
            ],
        },
        {
            "key": "source_short",
            ...
            "blocks": [
                ("text", "电源短路是用导线直接把电源正、负极连接起来，绕过用电器。", "corrected", "ASR 在 04:25 附近将“短路”误识为“断路”；根据教师随后明确的“很危险、大电流、烧坏电源”语境校正。"),
                ("text", "短路时电路电阻很小，电流会非常大，导线和电源会发热，严重时可能烧坏电源。", "corrected", "将“很吻、包了”等识别噪声按上下文规范为“大电流、发热、烧坏”。"),
                ("text", "安全提醒：不要用导线随意直接连接电池的正、负极，也不要把短路现象当作可随意尝试的实验。", "corrected", "对应视频 04:33–05:55 的明确警示。"),
        ...
        },
        {
            ...
            "blocks": [
                ...
                ("text", "判断电源短路不能只看线条位置；要看是否存在从电源正极经导线直接回到负极、绕过用电器的路径。", "inferred", "根据视频 08:00–09:55 的多种画法归纳。"),
        ...
        },
        {
            ...
            "blocks": [
                ...
                ("text", "被短路的用电器不工作；例如被导线绕过的灯泡不亮，而没有被短路且仍在回路中的灯泡可以继续发光。", "corrected", "对应视频 10:00–13:45 的 L1/L2 对比例子。"),
        ...
        },
        {
            ...
            "blocks": [
                ...
                ("text", "电流从 LED 正极（长脚）流入、从负极（短脚）流出时，LED 才发光；方向接反时不发光。", "corrected", "对应视频 14:06–15:30 的单向导电性说明。"),
        ...
        },
        {
            ...
            "blocks": [
                ...
                ("text", "法则二：有多条路径可选时，若存在导线等效的低电阻路径，电流会沿该路径通过，可能绕过用电器。", "corrected", "对应视频 05:55–07:30 以及结尾总结的第二条法则。"),
